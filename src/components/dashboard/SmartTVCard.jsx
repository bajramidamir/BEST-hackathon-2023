  ...
  return (
    <div className='bg-slate-50 shadow-lg p-4 rounded-lg grid grid-cols-2'>
      ...
      <div>
        ...
        <label className="flex justify-between justify-items-center p-2 text-xl">
        ...
        <div className="flex items-center justify-center w-full mt-5">
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target={'_blank'}><img className='w-10 h-10 inline-block mx-1 rounded-full ' src="/assets/youtube.svg" alt="" /></a>
