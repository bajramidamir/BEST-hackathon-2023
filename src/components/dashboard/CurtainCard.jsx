...
const CurtainCard = () => {
    const [curtainValue, setCurtainValue] = useState(50);

    const handleChange = (e) => {
      setCurtainValue(e.target.value);
    };

  return (
    <div className='bg-slate-50 shadow-lg p-4 rounded-lg grid grid-cols-2'>
    <div >
        {curtainValue > 0 ? <img  src="https://www.svgrepo.com/show/429450/blinds-circus-curtain.svg" /> : <img src="https://www.svgrepo.com/show/293751/curtain.svg"  />}
    </div>
    <div>
