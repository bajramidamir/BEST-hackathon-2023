...
const LightCard = () => {
  ...
  return (
    ...
    <div>
      ...
      <input id="default-range" type="range" value= {Value} className='w-full h-4 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-400' onChange={handleChange}></input>
